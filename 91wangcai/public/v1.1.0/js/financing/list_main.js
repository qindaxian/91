...
// description：理财列表页脚本
// author:shanghongliang 2015-3-23 15:11:50
// update
$(function () {
    //预期年化利率 项目期限 数字动画
    function AnimateNum(e) {
        this.obj = e.obj,
            this.target = e.target,//最终值
    ...
    function scrollNum() {
        ...
        e.each(function () {
            ...
            //？
            t.top <= $(this).offset().top + $(this).height() && t.bottom >= $(this).offset().top + $(this).height() / 2 && !$(this).data("start") && ($(this).data("start", !0), new AnimateNum({
                obj: $(this),
                target: e,
                totalTime: 1e3
            }))
    ...
    $(".pro_c6 .fd .btnFirst").hover(function () {
        $(this).html("查看详情")
    }, function () {
        $(this).html("已结束")
    });
    // 滑过显示阴影框
    $(".wrapList").on("mouseenter", ".projectList", function () {
        $(this).addClass("shade").stop().animate({ "margin-top": "-3px", "margin-bottom": "23px", }, 300);
    });
    $(".wrapList").on("mouseleave", ".projectList", function () {
        $(this).removeClass("shade").stop().animate({ "margin-top": "0px", "margin-bottom": "20px", }, 300);
    });
    // 广告位添加动效
    $(".listBottomTu").on("mouseenter", "a", function () {
        $(this).addClass("shade").stop().animate({ "margin-top": "-3px", "margin-bottom": "23px", }, 300);
    });
    $(".listBottomTu").on("mouseleave", "a", function () {
        $(this).removeClass("shade").stop().animate({ "margin-top": "0px", "margin-bottom": "20px", }, 300);
    });
});
