...
jQuery.fn.timelinr = function(options){
    ...
    $(function(){
        ...
        // 	var widthDate = $(settings.datesDiv+' li').width()+10;
        // }else{
        var widthDate = $(settings.datesDiv+' li').width()+10;
        // }
        // set positions!
...
Diary.prototype = {
    ...
    getData: function () {
        ...
        obj.success = function (data) {
            ...
            if (_status == '200') {
                ...
                $('#dates').html(_list1);
                //最新一年高亮
                $('#dates li:first-child').addClass('active')
                //列表点击切换
    ...
    //tab切换动态获取年份
    tabswitch: function (time) {
        var _that = this;
        var list1 = '<li>' + time + '</li>';
        return list1;
    },
    //获取日记数据
        ...
        obj.success = function (data) {
            ...
            if (_status == '200') {
                ...
                for (var i = 0; i < _data.length; i++) {
                    if (i % 2 == 0) {
                        _str.push('<li class="fl"><div class="shade"></div><div class="issues_main"><div class="issues_top clearfix"><p class="fl">' + _data[i].title + '</p><p class="fr">' + _data[i].title_time + '</p></div><div class="issues_content"><a href="' + _data[i].content_url + '" target="_blank"><img src="' + _data[i].file_url[0] + '" alt=""></a><p>' + _data[i].contents + '</p></div></div></li>')
                    } else {
                        _str.push('<li class="fr"><div class="shade"></div><div class="issues_main"><div class="issues_top clearfix"><p class="fl">' + _data[i].title + '</p><p class="fr">' + _data[i].title_time + '</p></div><div class="issues_content"><a href="' + _data[i].content_url + '" target="_blank"><img src="' + _data[i].file_url[0] + '" alt=""></a><p>' + _data[i].contents + '</p></div></div></li>')
                    }
                }
            }
            $('#issues').html(_str.join(''));
        };
        obj.error = function () { };
        WC.Core.ajax(obj);
    }
