...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('v1.1.0/css/report/report_index_style.css?t=1')}}">
    <!-- <link rel="stylesheet" type="text/css" href="{{asset('')}}v1.1.0/css/report/report_ForIE_style.css"> -->
...
<div class="wrapper" id="wrapper">
    ...
    <div class="banner_wrap">
        <img src="{{asset('v1.1.0/img/operateReport/index/banner.png')}}" id="banner_pc">
    </div>
        ...
        <script id="platformDataWrap" type="text/html">
            <div class="platform_data">
                <div class="headTop">
                    ...
                    <div class="safeYy">
                        <img src="{{asset('v1.1.0/img/operateReport/index/left.png')}}" class="left">
                        <p><l>稳健运营：</l><span class="comdify"></span>天</p>
                        <img src="{{asset('v1.1.0/img/operateReport/index/right.png')}}" class="right">
                    </div>
                    ...
                    <div class="dataAll">
                        <div class="first">
                            ...
                            <!-- <img src="{{asset('')}}v1.1.0/img/operateReport/index/jiao.png" class="jiao"> -->
                        </div>
    ...
    <div class="wrapOut" id="wrapper">
            ...
            <div class="monthRich" id="monthRich">
                <script id="monthRichWrap" type="text/html">
                    <div class="dataRich">
                        ...
                        <img src="{{asset('v1.1.0/img/operateReport/index/rich1.png')}}">
                        <p></p>
                        <p>月累计出借笔数<span class="comdify"></span>笔</p>
                    </div>
                    <div class="dataRich dataCent">
                        <h3>最<span>土豪</span>财主</h3>
                        <img src="{{asset('v1.1.0/img/operateReport/index/rich2.png')}}">
                        <p>  •  岁  •  </p>
                        <p>月累计出借金额<span class="comdify"></span>元</p>
                    </div>
                    <div class="dataRich">
                        <h3>最<span>聪明</span>财主</h3>
                        <img src="{{asset('v1.1.0/img/operateReport/index/rich3.png')}}">
                        <p>岁</p>
            ...
            <script id="manageDataWrap" type="text/html">
                ...
                <div class="heartServiceWrap">
                    ...
                    <div id="heartService">
                        ...
                        <div class="heartService">
                            <div class="weixin">
                                <img src="{{asset('v1.1.0/img/operateReport/index/weixin.png')}}">
                                <p>通过微信接待<span class="comdify"></span>位用户</p>
                            </div>
                            <img src="{{asset('v1.1.0/img/operateReport/index/line.jpg')}}" class="line">
                            <div class="weixin weixin2">
                                <img src="{{asset('v1.1.0/img/operateReport/index/qq.png')}}">
                                <p>通过QQ接待<span class="comdify"></span>位用户</p>
                            </div>
                            <img src="{{asset('v1.1.0/img/operateReport/index/line.jpg')}}" class="line2">
                            <div class="weixin">
                                <img src="{{asset('v1.1.0/img/operateReport/index/phone.png')}}">
                ...
                <div class="proIterationWrap">
                    ...
                    <div class="proIteration">
                        <div class="upLeft">
                            <p><b>UP</b><img src="{{asset('v1.1.0/img/operateReport/index/up.png')}}"></p>
        ...
        <div class="reportOldWrap">
            ...
            <div class="reportOld">
                <div class="imgAll">
                    <a href="/?operateReport1"><img src="{{asset('v1.1.0/img/operateReport/index/report4.png')}}"></a>
                    <a href="/?operateReport2"><img src="{{asset('v1.1.0/img/operateReport/index/report1.png')}}"></a>
                    <a href="/?operateReport3"><img src="{{asset('v1.1.0/img/operateReport/index/report2.png')}}"></a>
                    <a href="/?operateReport4"><img src="{{asset('v1.1.0/img/operateReport/index/report3.png')}}"></a>
                </div>
...
<!-- <script src="{{asset('v1.1.0/js/lib/highcharts.js')}}"></script>
<script src="{{asset('v1.1.0/js/lib/echarts.min.js')}}"></script>
<script src="{{asset('v1.1.0/js/lib/china.js')}}"></script>
<script src="{{asset('v1.1.0/js/lib/bootstrap.min.js')}}"></script>
<script src="{{asset('v1.1.0/js/lib/artTemplate/template.js')}}"></script>
<script src="{{asset('v1.1.0/js/report/index.js?t=3')}}"></script>
 -->
<script src="{{asset('v1.1.0/js/report/index_main.js')}}"></script>
