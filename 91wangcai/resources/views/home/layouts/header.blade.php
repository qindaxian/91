            ...
            <ul class="loginWrapRight clearfix">
                ...
                <li class="userHover">
                    ...
                    <div class="userInfoLink">
                        ...
                        <a href="/user/account/get?code=0.46592376994601115">我的账户</a>
                    </div>

                    <ul class="hideSlideMain hide">
                        <i class="top-arrow2 top-arrow"></i>
                        <li>
                            <a href="/user/account/get?code=0.46592376994601115">账户概况</a>
                        </li>
                        <li>
                            <a href="/user/recharge/to?code=0.46592376994601115" class="checkStatusBtn">充值提现</a>
                        </li>
                        <li>
                            <a href="/user/financial/chart?code=0.46592376994601115">借贷管理</a>
                        </li>
                        <li>
                            <a href="/user/commission?code=0.46592376994601115">我的佣金</a>
                        </li>
                        <li>
                            <a href="/user/redbonus?code=0.46592376994601115">红包礼券</a>
                        </li>
                        <li>
                            <a href="/user/setup?code=0.46592376994601115">账户设置</a>
                        </li>
                        <li>
                            <a href="/user/riskTest?code=0.46592376994601115">风险测评</a>
                        </li>
                    </ul>
                </li>
