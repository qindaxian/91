...
<link rel="stylesheet" type="text/css" href="http://www.91.com/admin/static/h-ui.admin/css/style.css" />
	...
	<!--_footer 作为公共模版分离出去-->
<script type="text/javascript" src="http://www.91.com/lib/jquery/1.9.1/jquery.min.js"></script> 
<script type="text/javascript" src="http://www.91.com/lib/layer/2.4/layer.js"></script>
<script type="text/javascript" src="http://www.91.com/static/h-ui/js/H-ui.js"></script> 
<script type="text/javascript" src="http://www.91.com/static/h-ui.admin/js/H-ui.admin.page.js"></script>
<!--/_footer /作为公共模版分离出去-->

<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="http://www.91.com/lib/jquery.validation/1.14.0/jquery.validate.js"></script> 
<script type="text/javascript" src="http://www.91.com/lib/jquery.validation/1.14.0/validate-methods.js"></script> 
<script type="text/javascript" src="http://www.91.com/lib/jquery.validation/1.14.0/messages_zh.js"></script> 
<script type="text/javascript" src="http://www.91.com/lib/webuploader/0.1.5/webuploader.min.js"></script> 
<script type="text/javascript" src="http://www.91.com/lib/ueditor/1.4.3/ueditor.config.js"></script>
<script type="text/javascript" src="http://www.91.com/lib/ueditor/1.4.3/ueditor.all.min.js"> </script>
<script type="text/javascript" src="http://www.91.com/lib/ueditor/1.4.3/lang/zh-cn/zh-cn.js"></script>
