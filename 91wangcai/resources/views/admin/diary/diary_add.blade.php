...
<div class="page-container">
	<form action="" method="" enctype="multipart/form-data" class="form form-horizontal" id="form-article-add">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>记事标题：</label>
		 ...
		 <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select name="d_type" class="select" id="type">
					...
					<option value="1">旺财日记</option>
					<option value="2">财主见面会</option>
				</select>
				</span> </div>
		</div>
		<div class="row cl" id="label" style="display: none;">
			<label class="form-label col-xs-4 col-sm-2">记事标签：</label>
			<div class="formControls col-xs-8 col-sm-9">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="" name="file_url">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>内容链接：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="" placeholder="" id="" name="content_url">
            </div>
        </div>
		<div class="row cl">
