...
<title>用户中心首页</title>
<!-- 导入用户中心样式开始 -->
<link href="<?php echo e(asset('static/v1.1.0/css/user/user_style.css?t=1')); ?>" rel="stylesheet" type="text/css">
<!-- 导入用户中心样式结束 -->
<!-- 分页样式 -->
</head>
<body>
...
<div class="minBox lbox">
    <div class="userImg"><img src="<?php echo e(asset('static/v1.1.0/img/user/bg.png')); ?>"></div>
    <ul class="uNav">
        <!-- 账户概况开始 -->
        <li>
            <p>
        ...
        <li>
            <p>
                ...
                <a href="<?php echo e(url('info/setup')); ?>" class=>账户设置</a>
            </p>
        </li>
        <!-- 账户设置结束 -->
        <!-- 风险测评开始 -->
                                ...
                                <div class="h_box">
                                    <div class="inside">
                                        <p>账户余额+冻结金额+普通项目待收+优先出借待收</p>
                                         <img src="<?php echo e(asset('static/v1.1.0/img/user/tip.png')); ?>">
                                    </div>
                                </div>
                                <img src="<?php echo e(asset('static/v1.1.0/img/user/wt.png')); ?>">
                            </div>
                        </div>
                    </li>
                    <li>
...
<!-- 数据展示 -->
<script src="<?php echo e(asset('static/v1.1.0/js/user/jquery.js')); ?>"></script>
...
<!-- 导入用户中心对应js开始 -->
<script src="<?php echo e(asset('static/v1.1.0/js/user/userIndex_main.js?t=5')); ?>"></script>
...
<?php echo $__env->make('home.layouts.base', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>