...
<head>
    ...
    <!-- 导入首页样式开始 -->
    <link href="<?php echo e(asset('v1.1.0/css/homepage/homepage_style.css')); ?>" rel="stylesheet" type="text/css">
    <!-- 导入首页样式结束 -->
    <!-- 导入轮播图样式开始 -->
    <!-- 导入轮播图样式结束 -->
    <div class="none">
...
<div class="sliderWrap">
    <div class="slider-wrap">
        ...
        <ul class="carousel">
            <?php $__currentLoopData = $slideArr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
               <li><img src="<?php echo e($v['url']); ?>"></li>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </ul>
        <ul class="img-index"></ul>
        <div class="carousel-prev"><img src="<?php echo e(asset('images/lbt/left_btn1.png')); ?>"></div>
        <div class="carousel-next"><img src="<?php echo e(asset('images/lbt/right_btn1.png')); ?>"></div>
    </div>
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/style.css')); ?>">
<script type="text/javascript" src="<?php echo e(asset('js/scripts/jquery.min.js')); ?>"></script>
<!-- <script src="http://www.jq22.com/jquery/jquery-1.10.2.js"></script> -->
<script type="text/javascript" src="<?php echo e(asset('js/scripts/carousel.js')); ?>"></script>
    <script type="text/javascript">
        $(function(){
            ...
            $(".carousel-prev").hover(function(){
                $(this).find("img").attr("src","<?php echo e(asset('images/lbt/left_btn2.png')); ?>");
            },function(){
                $(this).find("img").attr("src","<?php echo e(asset('images/lbt/left_btn1.png')); ?>");
            });
            $(".carousel-next").hover(function(){
                $(this).find("img").attr("src","<?php echo e(asset('images/lbt/right_btn2.png')); ?>");
            },function(){
                $(this).find("img").attr("src","<?php echo e(asset('images/lbt/right_btn1.png')); ?>");
            });
        });
    </script>
    </div>
                        ...
                        <li>
                            <label for="code" class="form_group_focus">
                                ...
                                <span class="codeImgWrap">
			  								<img src="<?php echo e(URL('home/captcha')); ?>" id="valicodeImg" alt="点击刷新" onclick="this.src='<?php echo e(URL('home/captcha')); ?>?t='+ Math.random()">
			  							</span>
...
<div class="wrap">
    ...
    <div class="noticeWrap">
        ...
        <div class="pinpai">
            <a href="/about/depository" target="_blank">
                <dl>
                    <dt><img src="<?php echo e(asset('v1.1.0/img/homepage/pic1.png')); ?>"></dt>
                    <dd>
                        <h2>银行存管</h2>
                        <p>厦门银行资金存管</p>
                        <p>厦门银行互联网金融核心客户</p>
            ...
            <a href="/about/qualification" target="_blank">
                <dl>
                    <dt><img src="<?php echo e(asset('v1.1.0/img/homepage/pic2.png')); ?>"></dt>
                    <dd>
                        <h2>合规自律</h2>
                        <p>中国互联网金融协会理事单位</p>
            ...
            <a href="/about/investor" target="_blank">
                <dl>
                    <dt><img src="<?php echo e(asset('v1.1.0/img/homepage/pic3.png')); ?>"></dt>
                    <dd>
                        <h2>战略投资人</h2>
                        <p>完成三轮融资</p>
                        <p>经纬中国、宽带资本、海通证券等</p>
    ...
    <!-- 理财项目结束 -->
    <a href="help/safety"><img src="<?php echo e(asset('v1.1.0/img/homepage/banner1.jpg')); ?>" alt="厦门银行存管，安全有保障"/></a>
    <!-- 媒体报道开始 -->
    <dl class="moduleItem">
        <dt>
            <h2 class="moduleTitle">
        ...
        <dd class="partnerList clearfix">
            <div class="list">
                <a href="/about/cooperation/#haitong">
                    <img src="<?php echo e(asset('v1.1.0/img/homepage/partner1.png')); ?>" alt="海通证券">
                </a>
            </div>
            <div class="list">
                <a href="/about/cooperation/#kuandai">
                    <img src="<?php echo e(asset('v1.1.0/img/homepage/partner3.png')); ?>" alt="宽带资本" >
                </a>
            </div>
            <div class="list">
                <a href="/about/cooperation/#jingwei">
                    <img src="<?php echo e(asset('v1.1.0/img/homepage/partner2.png')); ?>" alt="经纬中国" >
                </a>
            </div>
            <div class="list lastList">
                <a href="/about/cooperation/#xiamen">
                    <img src="<?php echo e(asset('v1.1.0/img/homepage/partner4.png')); ?>" alt="厦门银行" >
                </a>
            </div>
        </dd>
    </dl>
...
<!-- <script src="<?php echo e(asset('')); ?>v1.1.0/js/homepage/homepage_main.js"></script> -->
</div>
</body>
</html>
...
<script>
    ...
    function sendMessage() {
        ...
        var user_phone = $("input[name = 'phone']").val();
        var url = "<?php echo e(url('home/registers')); ?>";
        var error = $("#span_reg");
        $.ajax({
            url:url,
