...
<?php $__env->startSection('content'); ?>
    <!-- 导入关于我们的css开始... -->
    <link href="<?php echo e(asset('v1.1.0/css/about/about_style.css')); ?>" rel="stylesheet" type="text/css">
    <!-- 导入关于我们的css结束... -->
        ...
        <div class="innerMain">
            <div class="innerTab">
                ...
                <div class="content company">
                    <!-- <h2><img src="<?php echo e(asset('v1.1.0/img/about/aboutLogo.jpg')); ?>"></h2> -->
                    <div class="inner">
                    ...
                    <div class="contact clearfix">
                        ...
                        <div class="wcPic">
                            ...
                            <img src="<?php echo e(asset('v1.1.0/img/common/appcode.png')); ?>">
                        </div>
                    </div>
                    <div class="text">
                    ...
                    <h3>办公环境</h3>
                    <div class="picList">
                        <img src="<?php echo e(asset('v1.1.0/img/about/pic1.jpg')); ?>">
                        <img class="r" src="<?php echo e(asset('v1.1.0/img/about/pic2.jpg')); ?>">
                        <img src="<?php echo e(asset('v1.1.0/img/about/pic3.jpg')); ?>">
                        <img class="r" src="<?php echo e(asset('v1.1.0/img/about/pic4.jpg')); ?>">
                        <img src="<?php echo e(asset('v1.1.0/img/about/pic5.jpg')); ?>">
                        <img class="r" src="<?php echo e(asset('v1.1.0/img/about/pic6.jpg')); ?>">
                        <img src="<?php echo e(asset('v1.1.0/img/about/pic7.jpg')); ?>">
                        <img class="r" src="<?php echo e(asset('v1.1.0/img/about/pic8.jpg')); ?>">
                    </div>
                    <!-- <h3>联系我们</h3>
                    <p>先智创科（北京）科技有限公司</p>
...
<div class="dialogWrap">
    <div class="dialogBox">
        ...
        <div class="bd"><img src="<?php echo e(asset('v1.1.0/img/about/picBig1.jpg')); ?>"></div>
    </div>
</div>
</div>
<!--放大图片结束-->
...
<script src="<?php echo e(asset('v1.1.0/js/about/about_main.js')); ?>"></script>
