<div class="footer">
	<div class="wrap clearfix footerWrap">
        ...
        <dl class="footer_item codeWrap">
            ...
            <dd class="clearfix">
                <div class="codeItem wxCode">
                    <img src="<?php echo e(asset('static/v1.1.0/img/common/wxcode1.jpg')); ?>" alt="91旺财服务平台微信公众号">
                    扫描二维码关注微信
                </div>
                <!--     <div class="codeItem">
                    <img src="<?php echo e(asset('static/v1.1.0/img/common/wxcode2.jpg')); ?>" alt="91旺财服务平台微信公众号2">
                    扫描二维码关注微信
                </div> -->
            </dd>
        </dl>
        <dl class="footer_item">
            ...
            <dd class="footer_app">
                <img src="<?php echo e(asset('static/v1.1.0/img/common/appcode.png')); ?>" alt="91旺财app下载二维码">
            </dd>
        </dl>
    </div>
        ...
        <div class="wrap">
            <div class="codyrightItem">
                ...
                <div class="copyrightText">
                    ...
                    <span><a target="_blank" href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=11010202007186"><img src='<?php echo e(asset('static/v1.1.0/img/common/gongan.png')); ?>'>京公网安备 11010202007186号</a></span>
                </div>
            </div>
        </div>
    </div>
