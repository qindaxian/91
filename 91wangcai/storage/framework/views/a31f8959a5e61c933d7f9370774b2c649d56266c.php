	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<section class="page-404 minWP text-c">
			  ...
			  <p class="error-info">您可以：<a href="<?php echo e(url()->previous()); ?>" onclick="history.go(-1)" class="c-primary">&lt; 返回上一页</a><span class="ml-20">|</span><a href="<?php echo e(url('home/index')); ?>" class="c-primary ml-20">去首页 &gt;</a></p>
			</section>
		</article>
	</div>
</section>
