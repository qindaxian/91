...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('v1.1.0/css/report/report_index_style.css?t=1')); ?>">
    <!-- <link rel="stylesheet" type="text/css" href="<?php echo e(asset('v1.1.0/css/report/report_ForIE_style.css')); ?>"> -->
    <div style="display:none;">
        <script>
            var _hmt = _hmt || [];
            (function() {
                var hm = document.createElement("script");
                hm.src = "//hm.baidu.com/hm.js?8db064996a75a4788e09f230eb46ca82";
    ...
    <div class="slideWrap">
        ...
        <div class="slideContact">
            <div class="info">
                ...
                <p class="vt"><img src="<?php echo e(asset('v1.1.0/img/common/ico_tel.png')); ?>"/><span>400-000-0091</span></p>
                <h5><strong>QQ在线</strong></h5>
                <p class="vt"><img src="<?php echo e(asset('v1.1.0/img/common/ico_QQ.png')); ?>"/><a href="http://www.91wangcai.com/help/qq" target="_blank">点击咨询</a></p>
                <h5><strong>自助查询</strong></h5>
                <p class="vt"><img src="<?php echo e(asset('v1.1.0/img/common/ico_help.png')); ?>"/><a href="http://www.91wangcai.com/help/index" target="_blank">帮助中心</a></p>
                <h5><strong>官方微信</strong></h5>
                <img src="<?php echo e(asset('v1.1.0/img/common/weixin1.png')); ?>"/>
            </div>
        </div>
    </div>
...
<div id="header" class="header">
    ...
    <input type="hidden" value="<?php echo e(asset('v1.1.0')); ?>" id="ctx"/>
    <!-- 顶部公告开始 -->
    <!-- 顶部公告结束 -->
</div>
...
<div id="header" class="header">
    ...
    <div class="wrap navWrap clearfix">
        <h2 class="logo">
            <a href="/">
                <img src="<?php echo e(asset('static/v1.1.0/img/common/logo.png')); ?>" alt="91旺财">
            </a>
        </h2>
        <div class="nav">
            <ul class="headerNav">
                <li class="">
                    <a href="<?php echo e(url('home/index')); ?>">首页</a>
                </li>
                <li class="">
                    <a href="<?php echo e(url('home/projectlist')); ?>">项目列表</a>
                </li>
                <li id="diaryNav" class=" active">
                    <a href="<?php echo e(url('home/chronicle')); ?>" class="yunyingReportWc">旺财记事</a>
                    <div class="hideSlideMain hide">
                        ...
                        <ul class="diary">
                            <li>
                                <a href="<?php echo e(url('/caizhu')); ?>">财主见面会</a>
                            </li>
                            <li>
                                <a href="<?php echo e(url('/chronicle')); ?>">旺财日记</a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li id="reportNav" class="">
                    <a href="<?php echo e(url('home/operationreport')); ?>" class="yunyingReport">运营报告</a>
                    <!-- <div class="hideSlideMain hide">
                        <div class="topArrowBgWrap" >
                            <i class="top-arrow1"></i>
                            <i class="top-arrow2"></i>
                ...
                <li class=""><a href="<?php echo e(url('home/helpcenter')); ?>">帮助中心</a></li>
                <li class=""><a href="<?php echo e(url('home/informationdisclosure')); ?>">信息披露</a></li>
            </ul>
        </div>
        <div class="userNav">
            <ul class="loginWrapRight clearfix">
                ...
                <li id="nav_login_link" class="loginUrlLink">
                    <a href="<?php echo e(url('/user')); ?>" class="js_userTabLink" target="_blank">登录</a>
                </li>
                <li class="centerLine"><span>|</span></li>
                <li>
                    <a href="<?php echo e(url('/register')); ?>" class="js_userTabLink" target="_blank">注册</a>
                </li>
...
<div class="wrapper" id="wrapper">
    ...
    <div class="banner_wrap">
        <img src="<?php echo e(asset('v1.1.0/img/operateReport/index/banner.png')); ?>" id="banner_pc">
    </div>
        ...
        <script id="platformDataWrap" type="text/html">
            <div class="platform_data">
                <div class="headTop">
                    ...
                    <div class="safeYy">
                        <img src="<?php echo e(asset('v1.1.0/img/operateReport/index/left.png')); ?>" class="left">
                        <p><l>稳健运营：</l><span class="comdify"></span>天</p>
                        <img src="<?php echo e(asset('v1.1.0/img/operateReport/index/right.png')); ?>" class="right">
                    </div>
                    ...
                    <div class="dataAll">
                        <div class="first">
                            ...
                            <!-- <img src="<?php echo e(asset('v1.1.0/img/operateReport/index/jiao.png')); ?>" class="jiao"> -->
                        </div>
    ...
    <div class="wrapOut" id="wrapper">
            ...
            <div class="monthRich" id="monthRich">
                <script id="monthRichWrap" type="text/html">
                    <div class="dataRich">
                        ...
                        <img src="<?php echo e(asset('v1.1.0/img/operateReport/index/rich1.png')); ?>">
                        <p></p>
                        <p>月累计出借笔数<span class="comdify"></span>笔</p>
                    </div>
                    <div class="dataRich dataCent">
                        <h3>最<span>土豪</span>财主</h3>
                        <img src="<?php echo e(asset('v1.1.0/img/operateReport/index/rich2.png')); ?>">
                        <p>  •  岁  •  </p>
                        <p>月累计出借金额<span class="comdify"></span>元</p>
                    </div>
                    <div class="dataRich">
                        <h3>最<span>聪明</span>财主</h3>
                        <img src="<?php echo e(asset('v1.1.0/img/operateReport/index/rich3.png')); ?>">
                        <p>岁</p>
            ...
            <script id="manageDataWrap" type="text/html">
                ...
                <div class="heartServiceWrap">
                    ...
                    <div id="heartService">
                        ...
                        <div class="heartService">
                            <div class="weixin">
                                <img src="<?php echo e(asset('v1.1.0/img/operateReport/index/weixin.png')); ?>">
                                <p>通过微信接待<span class="comdify"></span>位用户</p>
                            </div>
                            <img src="<?php echo e(asset('v1.1.0/img/operateReport/index/line.jpg')); ?>" class="line">
                            <div class="weixin weixin2">
                                <img src="<?php echo e(asset('v1.1.0/img/operateReport/index/qq.png')); ?>">
                                <p>通过QQ接待<span class="comdify"></span>位用户</p>
                            </div>
                            <img src="<?php echo e(asset('v1.1.0/img/operateReport/index/line.jpg')); ?>" class="line2">
                            <div class="weixin">
                                <img src="<?php echo e(asset('v1.1.0/img/operateReport/index/phone.png')); ?>">
                ...
                <div class="proIterationWrap">
                    ...
                    <div class="proIteration">
                        <div class="upLeft">
                            <p><b>UP</b><img src="<?php echo e(asset('v1.1.0/img/operateReport/index/up.png')); ?>"></p>
        ...
        <div class="reportOldWrap">
            ...
            <div class="reportOld">
                <div class="imgAll">
                    <a href="/?operateReport1"><img src="<?php echo e(asset('')); ?>v1.1.0/img/operateReport/index/report4.png"></a>
                    <a href="/?operateReport2"><img src="<?php echo e(asset('')); ?>v1.1.0/img/operateReport/index/report1.png"></a>
                    <a href="/?operateReport3"><img src="<?php echo e(asset('')); ?>v1.1.0/img/operateReport/index/report2.png"></a>
                    <a href="/?operateReport4"><img src="<?php echo e(asset('')); ?>v1.1.0/img/operateReport/index/report3.png"></a>
                </div>
...
<!-- <script src="<?php echo e(asset('')); ?>v1.1.0/js/lib/highcharts.js"></script>
<script src="<?php echo e(asset('')); ?>v1.1.0/js/lib/echarts.min.js"></script>
<script src="<?php echo e(asset('')); ?>v1.1.0/js/lib/china.js"></script>
<script src="<?php echo e(asset('')); ?>v1.1.0/js/lib/bootstrap.min.js"></script>
<script src="<?php echo e(asset('')); ?>v1.1.0/js/lib/artTemplate/template.js"></script>
<script src="<?php echo e(asset('')); ?>v1.1.0/js/report/index.js?t=3"></script>
 -->
<script src="<?php echo e(asset('')); ?>v1.1.0/js/report/index_main.js"></script>
